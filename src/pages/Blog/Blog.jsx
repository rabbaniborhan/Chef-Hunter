...
const Blog = () => {
    return (
        <div className='relative'>
           ...
           <div className=' w-4/5 mx-auto'  ref={ref}>
            ...
            <h1 className='text-xl font-bold pt-8'>4th Questions:What is a custom hook, and why will you create a custom hook?</h1> 
            <p className=' pb-20'>
    ...
    <ReactToPdf targetRef={ref} filename="div-blue.pdf">
        {({toPdf}) => (
             <div className=' mb-6  absolute bottom-0 left-1/2'> <button className="btn bg-gradient-to-r from-indigo-600 to-purple-600  " onClick= 
              {toPdf}>Genarate PDF</button></div>
        )}
    </ReactToPdf>
